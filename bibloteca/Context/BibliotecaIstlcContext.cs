...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=ACER\\MSSQLSERVER01; Database=BibliotecaIstlc; Integrated Security=True; Trust Server Certificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Autor>(entity =>
        {
            entity.HasKey(e => e.IdAutor).HasName("PK__AUTOR__DA37C137CE2655A0");
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__CATEGORI__4BD51FA519502AAB");
        ...
        {
            entity.HasKey(e => e.IdEditorial).HasName("PK__EDITORIA__EA05B1D719ACD2E7");
        ...
        {
            entity.HasKey(e => e.IdLibros).HasName("PK__INVENTAR__0ECE31B227977506");
        ...
        {
            entity.HasKey(e => e.IdLibros).HasName("PK__LIBROS__0ECE31B262FD4BB6");
        ...
        {
            entity.HasKey(e => e.IdMovimiento).HasName("PK__MOVIMIEN__44BC2ADA2141E003");
        ...
        {
            entity.HasKey(e => e.IdMulta).HasName("PK__MULTAS__1C1448B274C437D9");
        ...
        {
            entity.HasKey(e => e.IdNovedad).HasName("PK__NOVEDADE__FE457EA1BC72BBC7");
        ...
        {
            entity.HasKey(e => e.IdPrestamo).HasName("PK__PRESTAMO__3D5A1E6C196FC001");
        ...
        {
            entity.HasKey(e => new { e.IdPrestamo, e.IdDetalle }).HasName("PK__PRESTAMO__561558C93673FCBC");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__USUARIOS__91136B90031F37FE");
